...
definitions = {'definitions': {'Adv_compr': {'type': 'object', 'properties': {'time': {'type': 'string'}, 'coefficients': {'type': 'number', 'format': 'double'}, 'p': {'type': 'number', 'format': 'double'}}}, 'Chatfuel_text': {'type': 'object', 'properties': {'messages': {'type': 'object', 'properties': {'text': {'type': 'string'}}}}}}, 'parameters': {}}
